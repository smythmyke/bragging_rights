...
class PoolAutoGenerator {
  ...
  Future<void> generateGamePools({
    ...
    try {
      ...
      // NBA-specific: Check if this is a game without odds (exhibition/preseason)
      if (game.sport.toUpperCase() == 'NBA' && game.hasOdds == false) {
        debugPrint('🏀 NBA game without odds detected - generating simple pick pools');
