...
/// Live NFL data test - verifies odds and props are working
void main() async {
  final apiKey = '51434300fd8bc16e4b57de822b1d4323';
  
  print('🏈 NFL LIVE DATA TEST');
  print('=' * 60);
  
  // 1. Get current NFL games
  print('\n1️⃣ GETTING NFL GAMES...');
  ...
  try {
    ...
    if (events.isEmpty) {
      print('No NFL games available right now');
      return;
    }
    ...
    for (int i = 0; i < gamesToTest.length; i++) {
      ...
      final oddsUrl = 'https://api.the-odds-api.com/v4/sports/americanfootball_nfl/events/$gameId/odds'
      ...
      final propsUrl = 'https://api.the-odds-api.com/v4/sports/americanfootball_nfl/events/$gameId/odds'
          '?apiKey=$apiKey&regions=us'
          '&markets=player_pass_tds,player_pass_yds,player_rush_yds,player_reception_yds,player_receptions,player_anytime_td'
          '&oddsFormat=american';
